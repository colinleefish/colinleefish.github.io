---
layout: post
title: "Vagrant: 开发环境下的虚拟机使用新方式"
tags: vagrant,virtualbox,ansible,provision,test environment,
unsplash_id: uZqJVqwFxMQ
excerpt: 使用 Vagrant，用户能够用可追溯、可定义的文本文件来创建虚拟机，并且还能在公网范围进行 Web 或 SSH 共享。“环境不同”导致运行失败的情况再也不会发生了。
---
